...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    ...
    key: 'teacher-profile-update',
    tenantPath: ['organization', 'user'],
    userPath: [],
  },
  'student.delete': {
    roles: ['school-administrator', 'teacher'],
    key: 'student-removed',
    tenantPath: ['organization', 'student'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['school-administrator', 'teacher', 'it-support'];
