...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['organization', 'grade.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['first_name.contains', 'last_name.contains', 'student_grade.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'student_grade', header: 'Student Grade', accessorKey: 'student_grade' },
