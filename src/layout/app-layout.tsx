...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['school-administrator', 'teacher', 'it-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Courses', path: '/courses', entity: 'course', service: AccessServiceEnum.PROJECT, icon: FiBook },
    { name: 'Grades', path: '/grades', entity: 'grade', service: AccessServiceEnum.PROJECT, icon: FiStar },
